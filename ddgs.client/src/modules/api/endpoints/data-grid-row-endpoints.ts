      ...
      async onQueryStarted(args: DataGridRowCreateArgs, { dispatch, queryFulfilled }) {
        ...
        const createResult = dispatch(
          resourceApiSlice.util!.updateQueryData(
            ...
            // TODO: Разобраться почему при сборке (без ts-ignore) возникает ошибка error TS2345: Argument of type '{ dataGridId: string; }' is not assignable to parameter of type 'never'.
