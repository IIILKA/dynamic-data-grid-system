...
export default function DataGridLoader({ isDarkTheme }: DataGridLoaderProps) {
    ...
    const fetchingQueriesCount = useSelector((state: RootState) => state.dataGrid.fetchingQueriesCount);
    ...
    return (
        <>
            ...
            {fetchingQueriesCount === 0 && isVisible && <DataGridLoaderText style={{ color }}>All changed saved</DataGridLoaderText>}
        </>
    );
}
